	...
	const XMLElement* _bodyElement, int depth) 
{
	...
	_bodyParam->posLocal[0] = _bodyLocalPosVec[0];
	_bodyParam->posLocal[1] = _bodyLocalPosVec[1];
	_bodyParam->posLocal[2] = _bodyLocalPosVec[2];
...
BodyParam* MujocoXmlParser::Load(const char* pXmlFileName, float _scale)
{
	this->fScale = _scale;
