...
class ParallelMatrix<Eigen::Matrix<T,R,C>> {
 public:
  ...
  typedef std::vector<Vec>vector_type;
  typedef typename std::vector<Vec>::const_iterator const_iterator;
  typedef typename std::vector<Vec>::iterator iterator;
